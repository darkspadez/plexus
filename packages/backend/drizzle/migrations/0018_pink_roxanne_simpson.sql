...
--> statement-breakpoint
CREATE UNIQUE INDEX `uq_oauth_credentials` ON `oauth_credentials` (`oauth_provider_type`,`account_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `user_quota_definitions_name_unique` ON `user_quota_definitions` (`name`);
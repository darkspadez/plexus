    ...
    <div className="h-[60vh]">
      {concurrencyHistory.length === 0 ? (
        ...
        <div className="h-full flex flex-col">
          <div className="flex items-center justify-between p-4 bg-surface-elevated/50 rounded-lg mb-4">
            <span className="text-sm text-foreground-muted">Current In-Flight</span>

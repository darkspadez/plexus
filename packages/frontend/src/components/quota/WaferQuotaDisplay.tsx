...
export const WaferQuotaDisplay: React.FC<WaferQuotaDisplayProps> = ({ result, isCollapsed }) => {
  ...
  if (windows.length === 0) {
    return (
      <div className="px-2 py-2 flex items-center gap-2 text-foreground-muted">
        <TrendingUp size={16} />
  ...
  return (
    <div className="px-2 py-1 space-y-3">
      <div className="flex items-center gap-2 min-w-0">
        <span className="text-xs font-semibold text-foreground whitespace-nowrap">Wafer</span>
      </div>

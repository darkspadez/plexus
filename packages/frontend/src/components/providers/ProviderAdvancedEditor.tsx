                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          >
                            <button
                              ...
                              className="flex h-4 w-4 items-center justify-center rounded-full text-foreground-subtle transition-colors hover:bg-surface-elevated hover:text-foreground-muted focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-accent"
                            >
                              <Info size={12} />
                            </button>
                          </Tooltip>

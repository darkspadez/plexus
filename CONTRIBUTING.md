...
3. **(Optional)** Validate locally by running `bun run generate-migrations --name <descriptive-name>` from `packages/backend/` -- this confirms your schema produces valid migration SQL
